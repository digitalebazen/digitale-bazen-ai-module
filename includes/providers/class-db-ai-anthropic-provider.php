...
- ZOEKWOORDDICHTHEID (cruciaal — wordt vaak te laag gerekend): RankMath meet de dichtheid UITSLUITEND op het EXACTE focus keyword (letterlijk dezelfde woorden in dezelfde volgorde). Synoniemen, verbuigingen en varianten tellen NIET mee voor deze meter. Laat daarom het exacte hoofdzoekwoord met een dichtheid van 1,8-2,2% terugkomen — bij een artikel van 2500-3200 woorden is dat ongeveer 50-65 keer, verspreid over álle blocks (intro, body-tekstvelden, minstens enkele tussenkoppen, FAQ-antwoorden en conclusie). Behandel dit als een ONDERGRENS-doel: liever iets te vaak dan te weinig, want hij blijft anders steken op "te laag". Varianten/synoniemen zijn EXTRA bovenop dit aantal, niet in plaats ervan. Verweef alles natuurlijk in lopende zinnen; vermijd stuffen, herhaling binnen één zin, en plaatsing alleen in titels. Bij een lang meerwoordig keyword mag je aan de onderkant van de marge zitten, maar nooit onder ~1,5%. Pas alleen op voor over-optimalisatie boven ~2,5%.
